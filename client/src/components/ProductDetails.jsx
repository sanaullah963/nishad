...
function ProductDetails({ params }) {
  ...
  const arr = [
    "🔥দাম মাত্র ৬৯৯ টাকা।",
    "🚚ডেলিভারি চার্জ একদম ফ্রী",
    "---",
    "🔹দ্রুত বী*র্যপাতের স্থায়ী সমাধান।",
    "🔹৩০–৪৫ মিনিট সহ*বাস করতে পারবেন।",
    "🔹দিনে ৩–৫ বার করারর সক্ষমতা।",
    "🔹সহ*বাসে দীর্ঘস্থায়ী নিয়ন্ত্রণ।",
    "🔹বী*র্য ঘন ও শক্তিশালী হ...",
    "🔹শারীরিক ও মানসিক শক্তি বৃদ্ধি।",
    "🔹সঙ্গীকে পরিপূর্ন তৃপ্তি দিতে সাহায্য করবে।",
    "----",
          ...
          <div className=" ">
            <div>
              ...
              <textarea
                name="address"
                id="address"
                className=" border border-gray-400 rounded-md w-full min-h-24 h-auto p-1 my-2 text-gray-600 bg-white"
